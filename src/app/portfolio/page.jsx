...
const items = [
    {
        ...
        link: "https://shahreyar-portfoliowebsite.netlify.app/",
    },
    {
        id: 2,
                        ...
                        {items.map((item) => (
                            ...
                            >
                                <div className="flex flex-col gap-2 text-white">
                                    ...
                                    <div className="relative w-80 h-56 md:w-196 lg:w-[500px]">
                                    ...
                                    <Link href={item.link} className="flex justify-end">
                                        <button className="p-2 text-sm md:text-md lg:p-4 lg:text-lg bg-white text-gray-600 font-semibold m-2 rounded">See Demo</button>
                                    </Link>
                                </div>
                            </div>
                        ))}
